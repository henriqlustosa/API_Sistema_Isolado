...
public class AssessorUltimoCadastroInseridoDto {
	...
	public static Paciente paciente() {
		...
		String strSql ="select * from agh.v_paciente where cd_prontuario =(select max(cd_prontuario) from agh.v_paciente)";
		try {
